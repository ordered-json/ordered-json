...
The C extension implements strict parsing and associative JSON serialization. Applications use the [common PHP package](../php/README.md). The extension's `ordered_json` version and the PHP runtime version are separate; both are recorded in [verification.json](../docs/verification.json).
